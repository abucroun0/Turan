...
void InitSAMP(JNIEnv* pEnv, jobject thiz)
{
	...
	g_pszStorage  = "/storage/emulated/0/GoldenRP/files/";;
...
/*		for (int i = 0; i < MAX_SERVERS; i++)
		...
		//pNetGame = new CNetGame(cryptor::create("5.57.39.109", 19).decrypt(), atoi(cryptor::create("7777", 4).decrypt()), pSettings->GetReadOnly().szNickName, pSettings->GetReadOnly().szPassword);
