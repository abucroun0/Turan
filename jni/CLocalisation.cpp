...
char CLocalisation::m_szMessages[E_MSG::MSG_COUNT][MAX_LOCALISATION_LENGTH] = {
	"{Ff0000}Serverga Ulanmoqda...",
	"",
	"{ffffff}Serverga, Qayta Ulanmoqda",
	"",
	"unused",
	"{ff0000}IP Manzilingiz Server Tomonidan Bloklandi!{ffcc00} Qaytadan Ulanishga Harakat Qiling",
	"Server Bilan Aloqangiz Uzildi! Qaytadan Ulaning...",
	"Qayta Ulanish...",
	""
};
